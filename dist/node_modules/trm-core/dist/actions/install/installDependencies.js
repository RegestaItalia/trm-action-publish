    ...
    run: (context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (continueInstall) {
            ...
            for (const installDependency of dependenciesToInstall) {
                ...
                if ((!installDependency.registry || installDependency.registry.trim() === registry_1.PUBLIC_RESERVED_KEYWORD) && context.runtime.registry.getRegistryType() === registry_1.RegistryType.PUBLIC) {
                    dependencyRegistry = context.runtime.registry;
                }
                else {
                    dependencyRegistry = new registry_1.Registry(installDependency.registry || registry_1.PUBLIC_RESERVED_KEYWORD);
                }
                const inputData = {
