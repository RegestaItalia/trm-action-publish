...
class Registry {
    ...
    authenticate(inquirer, logger, defaultData = {}) {
    ...
    _basicAuth(inquirer, logger, defaultData = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._axiosInstance = axios_1.default.create(axiosDefaults);
            this._authData = {
                username,
                password
            };
    ...
    _tokenAuth(inquirer, logger, defaultData = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            var axiosHeaders = new axios_1.AxiosHeaders();
            var axiosDefaults = {
                baseURL: this.endpoint,
    ...
    _oauth2(inquirer, logger, defaultData = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const ping = yield this.ping();
                ...
                try {
                    ...
                    if (elapsedSeconds >= parseInt(tokenExpiry)) {
                        if (refreshToken) {
                            ...
                            oAuth2Response = (yield (axios_1.default.create({
                                baseURL: this.endpoint
    ...
    getArtifact(name, version = 'latest') {
        return __awaiter(this, void 0, void 0, function* () {
