        ...
        if (oAbapManifest.dependencies && oAbapManifest.dependencies.item) {
            if (Array.isArray(oAbapManifest.dependencies.item)) {
                ...
                manifest.dependencies = [{
                        name: (_c = oAbapManifest.dependencies.item.name) === null || _c === void 0 ? void 0 : _c.text,
                        integrity: (_d = oAbapManifest.dependencies.item.integrity) === null || _d === void 0 ? void 0 : _d.text,
                        version: (_e = oAbapManifest.dependencies.item.version) === null || _e === void 0 ? void 0 : _e.text,
                        registry: (_f = oAbapManifest.dependencies.item.registry) === null || _f === void 0 ? void 0 : _f.text
                    }];
            }
        }
