...
export declare class TrmPackage {
    ...
    private _devclass;
    constructor(packageName: string, registry: Registry, manifest?: Manifest, _logger?: Logger);
    ...
    publish(data: {
        ...
        readme?: string;
    }, skipLog?: boolean): Promise<TrmPackage>;
    compareRegistry(registry: Registry): boolean;
    compareName(name: string): boolean;
    private _viewLatest;
    static create(manifest: Manifest, registry: Registry, logger?: Logger): Promise<TrmPackage>;
