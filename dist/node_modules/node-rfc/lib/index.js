...
exports.languageSapToIso = exports.languageIsoToSap = exports.cancelClient = exports.sapnwrfcEvents = exports.setLogFilePath = exports.loadCryptoLibrary = exports.reloadIniFile = exports.setIniFileDirectory = void 0;
const events_1 = require("events");
const worker_threads_1 = require("worker_threads");
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
__exportStar(require("./noderfc-bindings"), exports);
__exportStar(require("./sapnwrfc-client"), exports);
__exportStar(require("./sapnwrfc-pool"), exports);
__exportStar(require("./sapnwrfc-throughput"), exports);
__exportStar(require("./sapnwrfc-server"), exports);
const noderfc_bindings_1 = require("./noderfc-bindings");
function setIniFileDirectory(iniFileDirectory) {
    const fullPath = path_1.default.join(iniFileDirectory, "sapnwrfc.ini");
...
function loadCryptoLibrary(libAbsolutePath) {
    if (!fs_1.default.existsSync(libAbsolutePath)) {
...
function setLogFilePath(filePath) {
    noderfc_bindings_1.noderfc_binding.setLogFilePath(filePath);
}
exports.setLogFilePath = setLogFilePath;
exports.sapnwrfcEvents = new events_1.EventEmitter();
function terminate(workerData) {
    return new Promise((resolve, reject) => {
        const terminator = new worker_threads_1.Worker(path_1.default.join(__dirname, "./cancel.js"), {
            workerData,
        });
