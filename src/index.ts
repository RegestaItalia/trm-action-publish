...
main({
    ...
    inc: getInput("inc", { required: true, trimWhitespace: true }),
    preRelease: getBooleanInput("preRelease", { required: true, trimWhitespace: true }),
    preReleaseIdentifier: getInput("preReleaseIdentifier", { required: false, trimWhitespace: true }),
    tags: getInput("tags", { required: false, trimWhitespace: true }),
